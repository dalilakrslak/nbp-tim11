...
public class UserController {
    ...
    @Operation(
            summary = "Postavlja profilnu sliku prijavljenog korisnika",
            description = "Uploaduje ili zamjenjuje profilnu sliku prijavljenog korisnika kao binarni BLOB."
    )
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "Profilna slika uspješno sačuvana"),
            @ApiResponse(responseCode = "400", description = "Datoteka nije poslata ili nije slika"),
            @ApiResponse(responseCode = "401", description = "Korisnik nije autentificiran")
    })
    @PostMapping(value = "/user/me/profile-picture", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    ...
    @Operation(
            summary = "Dohvaća profilnu sliku prijavljenog korisnika",
            description = "Vraća spremljenu profilnu sliku prijavljenog korisnika."
    )
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Profilna slika uspješno vraćena"),
            @ApiResponse(responseCode = "404", description = "Profilna slika nije pronađena"),
            @ApiResponse(responseCode = "401", description = "Korisnik nije autentificiran")
    })
    @GetMapping("/user/me/profile-picture")
    public ResponseEntity<byte[]> getProfilePicture(
            @Parameter(hidden = true) final Authentication authentication) {
        final User user = userService.getProfilePictureOwner(authentication.getName());
        final MediaType mediaType = MediaType.parseMediaType(user.getProfilePictureContentType());
    ...
    @Operation(
            summary = "Briše profilnu sliku prijavljenog korisnika",
            description = "Uklanja spremljenu profilnu sliku prijavljenog korisnika."
    )
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "Profilna slika uspješno obrisana"),
            @ApiResponse(responseCode = "401", description = "Korisnik nije autentificiran")
    })
    @DeleteMapping("/user/me/profile-picture")
